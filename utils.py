...
def get_piano_notes():
    ...
    base_freq = 442 #Frequency of Note A4
    keys = get_keys()
...
def apply_pedal(note_values, bar_value):
    ...
    '''
    print(f"sum(note_values): {sum(note_values)}\n")
    print(f"bar_value: {bar_value}\n")
    ...
    while True:
        ...
        # added a try...except here in case the list of durations
        #     is not ordered into groupings that match the bar_value
